...
>>>>>>> master
	...
	%Design DP0, DP1-7.  First a Noun; can be quantified or compared.
	\subsection{Physical Solution}\label{PS}
	The Physical solution for the Functional requirement in chapter \ref{FR} are;
	\begin{quote} 
		\textbf{\PS0} : Lightboard with mechanical linkage system.
	...
	%The market is also the whole world but then it would be done with partners to save transport.
	%The market is also the whole world with internet sales.
	\begin{table*}[]
		\centering
		\begin{tabular}{lrr|r}
			\hline
